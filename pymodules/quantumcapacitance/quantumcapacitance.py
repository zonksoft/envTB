...
class QuantumCapacitanceSolver:
    ...
    Usage:
    1) Create object: qcsolver=QuantumCapacitanceSolver(container,solver,elements,operator)
    2) Calculate classical dependency of charge on every possible potential configuration of elements:
    ...
    def __init__(self,container,solver,elements,charge_operator):
        ...
        solver: the solution of the system, e.g. generated by my_container.lu_solver().
        elements: the elements (from the system described by container) that participate in the
                  calculation. The property fermi_energy_charge_dependence needs to be set.
        charge_operator: The operator which gives the charge (without \epsilon_0).
        """
        self.container=container
        self.solver=solver
